# [Render State in the User Interface](https://www.freecodecamp.org/learn/front-end-development-libraries/react/render-state-in-the-user-interface)
...
2. MyCompo`n`ent should render an `h1` heading element enclosed in a single `div`.
3. The rendered `h1` heading element should only contain text rendered from the component's state.
