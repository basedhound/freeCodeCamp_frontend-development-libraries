...
## Practice
1. You should add an i element with the classes fas and fa-thumbs-up.
2. Your fa-thumbs-up icon should be located within the Like button.
3. Your i element should be nested within your button element.
4. Your icon element should have a closing tag.

## Problem Explanation
The challenge requires you to add a thumbs up icon from font awesome to the button with the text ‘Like’ in it

- Hint 1 -> The <i> tag is not self-closing.
- Hint 2 -> Use the classes fas and fa-thumbs-up.
