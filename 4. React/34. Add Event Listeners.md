# [Add Event Listeners](https://www.freecodecamp.org/learn/front-end-development-libraries/react/add-event-listeners)
...
2. A `keydown` listener should be attached to the document in `componentDidMount`.
3. The `keydown` listener should be removed from the document in `componentWillUnmount`.
4. Once the component has mounted, pressing `enter` should update its state and the rendered `h1` tag.
