# [Responsively Style Checkboxes](https://www.freecodecamp.org/learn/front-end-development-libraries/bootstrap/responsively-style-checkboxes)
...
1. All of your checkboxes should be nested inside one div with the class row.
2. Each of your checkboxes should be nested inside its own div with the class col-xs-4.
